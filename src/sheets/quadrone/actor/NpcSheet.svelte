<script lang="ts">
  ...
  let themed = $derived(!!context.themeSettings.actorHeaderBackground);
</script>

<header class="sheet-header flexcol {themed ? 'theme-dark' : 'theme-parchment'}">
...
<div class="sheet-body {themed ? 'themed' : 'theme-parchment'}">
